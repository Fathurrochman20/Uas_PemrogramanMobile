...
public class MainActivity extends AppCompatActivity {
    ...
    private CardView buttonMovie_Ivan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMovie_Ivan = findViewById(R.id.movie_ivan);
    ...
    private void setToolbar() {
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("IVAN FATHURROCHMAN AHCMAD");
    ...
    private void setIntent() {
        ...
        buttonMovie_Ivan.setOnClickListener(view -> {
            Intent intent = new Intent(this, MovieIvanActivity.class);
            startActivity(intent);
        });
